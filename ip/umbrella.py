...
class Umbrella():
    def __init__(self):
        conffile = os.path.join(os.path.dirname(__file__), 'umbrella.conf')
...
#    domain = ArgParse().resource
#    print(json.dumps(Umbrella().get_score(domain)))
#    print(json.dumps(Umbrella().get_samples(domain)))
